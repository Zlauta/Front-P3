...
const Hero = () => {
  ...
  useEffect(() => {
    const intervalo = setInterval(() => {
      setIndiceActual((indiceAnterior) => (indiceAnterior + 1) % imagenesHero.length);
    }, DURACION_SLIDE);
    ...
    <section className="hero-seccion">
      ...
      <div className="hero-contenido">
        ...
        <p className="hero-subtitulo">
          Descubre una experiencia gastronómica inolvidable donde la tradición se encuentra con la
          innovación.
        </p>
      </div>
    </section>
