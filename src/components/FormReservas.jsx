  ...
  return (
    <Container className="mt-5 mb-5">
      <Row className="justify-content-center">
        <Col xs={12} md={8} lg={6}>
          <Card style={{ backgroundColor: "#254630", color: "#ffffff", border: "none", borderRadius: "16px", boxShadow: "0 4px 30px rgba(0,0,0,0.5)" }}>
            <Card.Body className="p-4">
              ...
              <Form noValidate onSubmit={handleSubmit(handleReservaSubmit)}>
                <Row>
                  <Col xs={6}>
                    <Form.Group className="mb-3" controlId="cantidadPersonas">
                      ...
                      />
                      <Form.Control.Feedback type="invalid">{errors.cantidadPersonas?.message}</Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                  ...
                  <Col xs={6}>
                    <Form.Group className="mb-3" controlId="mesa">
                      ...
                      />
                      <Form.Control.Feedback type="invalid">{errors.mesa?.message}</Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                </Row>
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group className="mb-3" controlId="hora">
                      ...
                      <Form.Control
                        ...
                        {...register("hora", {
                          required: "Requerido",
                          pattern: { value: /^([01]\d|2[0-3]):([0-5]\d)$/, message: "Hora inválida" },
                          validate: {
                            checkHorario: (val) => validarHorarioAtencion(val) || "Horarios de atencion 10hs a 16hs y 21hs a 02hs",
                            checkPasado: (val) => (fechaSeleccionada === minDate && val < minTime ? "Hora inválida hoy" : true),
                            checkDisponibilidad: (val) => verificarDisponibilidad(val) || "Mesa ocupada (margen 2hs)"
                          }
                        })}
                      />
                ...
                <Form.Group className="mb-4" controlId="notas">
                  ...
                  <Form.Control
                    as="textarea" rows={3} placeholder="Preferencias..." isInvalid={!!errors.notas}
                    {...register("notas", { maxLength: { value: 200, message: "Máx 200 caracteres" } })}
                  />
                  <Form.Control.Feedback type="invalid">{errors.notas?.message}</Form.Control.Feedback>
                </Form.Group>

                <div className="text-center">
                  <Button type="submit" disabled={!isValid || loading} className="w-100" style={{ backgroundColor: isValid ? "#1aaf4b" : "#5a5a5a", border: "none" }}>
