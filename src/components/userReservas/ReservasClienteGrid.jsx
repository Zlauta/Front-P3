          ...
          <Col key={reserva._id}>
            <Card className="h-100 shadow-sm border-0" style={{ background: '#25332f' }}>
              ...
              <Card.Header className="d-flex justify-content-between align-items-center border-bottom border-secondary bg-transparent py-2">
                ...
                <Badge bg="success" className="text-dark flex-shrink-0 ms-1">Confirmada</Badge>
              </Card.Header>
              ...
              <Card.Body className="text-white d-flex flex-column p-3">
                ...
                <div className="small">
                    ...
                    <span className="text-white-50"><FaCalendarAlt className="me-2" />Fecha:</span>
                    <span>{formatearFecha(reserva.fecha)}</span>
                    </div>
                    <div className="d-flex justify-content-between mb-2 border-bottom border-secondary pb-2">
                    <span className="text-white-50"><FaClock className="me-2" />Hora:</span>
                    <span>{reserva.hora} hs</span>
                    </div>
                    <div className="d-flex justify-content-between">
                    <span className="text-white-50"><FaUsers className="me-2" />Personas:</span>
              ...
              <Card.Footer className="bg-transparent border-top-0 d-flex gap-2 pb-3 pt-0 px-3">
                ...
                {esEditable ? (
                  <Button variant="outline-light" size="sm" className="w-50" onClick={() => onEditar(reserva)}>
                  ...
                  >
                    <span className="d-inline-block w-50">
                      <Button variant="outline-secondary" size="sm" className="w-100" disabled style={{ pointerEvents: 'none', opacity: 0.5 }}>
                        <FaEdit className="me-1" /> Modificar
                      </Button>
                    </span>
                  </OverlayTrigger>
                ...
                <Button variant="outline-danger" size="sm" className="w-50" onClick={() => onEliminar(reserva._id)}>
